...
interface NativeToken1155MarketInterface extends ethers.utils.Interface {
  functions: {
    "activeItems()": FunctionFragment;
    "batchListItem(address[],uint256[],uint256[])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "batchListItem",
  ...
  events: {
    ...
    "ItemListed(uint256,address,uint256,address,uint256)": EventFragment;
    "ItemSold(uint256,address,uint256,address,uint256)": EventFragment;
...
export class NativeToken1155Market extends BaseContract {
  ...
  interface: NativeToken1155MarketInterface;
  ...
  filters: {
    ...
    "ItemListed(uint256,address,uint256,address,uint256)"(
      itemId?: BigNumberish | null,
    ...
    "ItemSold(uint256,address,uint256,address,uint256)"(
      itemId?: BigNumberish | null,
      nftContract?: string | null,
      tokenId?: BigNumberish | null,
      buyer?: null,
